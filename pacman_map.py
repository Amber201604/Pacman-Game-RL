...
##    new_cook.append(n)
##
##for newc in new_cook:
##    pacmap[newc[0], newc[1]] = 1
##
##for wall in walls_pos:4
##
##print(pacmap)
#print(new_cook)
